...
import { BtModelSearchComponentsDto } from './bt-model-search-components.dto';
import { RelationType } from '../../relation-type/relation-type.enum';

export class RetrieveSearchBtModelDto {

    constructor(id?:number, userId?:number, name?:string, relationType?:RelationType, xperMentor?:boolean, company?:string,
        ...
        negativeExternalities?:string, insights?:string, distance?:number, foundComponents?: BtModelSearchComponentsDto) {
    ...
    @ApiModelProperty()
    found: BtModelSearchComponentsDto;
}